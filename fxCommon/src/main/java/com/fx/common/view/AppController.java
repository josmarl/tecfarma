...
public class AppController {
    ...
    public static WindowMain winFx;

    @FXML
    protected void openWindows(int index) throws IOException {
        Screen screen = winFx.windows[index];
        loader = new FXMLLoader(new URL(winFx.pathFxml + screen.getFxmlWindow()));
        AnchorPane newApWindow = (AnchorPane) loader.load();
        newApWindow.setPrefWidth(winFx.apMain.getWidth());
        newApWindow.setPrefHeight(winFx.apMain.getHeight());
        winFx.apMain.getChildren().setAll(newApWindow);
    }
    ...
    protected AnchorPane loadFxml(int index) throws MalformedURLException, IOException {
        ...
        AnchorPane ap;
        FXMLLoader loaderx;
        loaderx = new FXMLLoader(new URL(winFx.pathFxml + screen.getFxmlWindow()));
