package com.sjcontable.util.object;
 ...
 */
public class SanJavierCalendar extends Calendar {

    private long tiempo;
    private String formatStandar = "dd/MM/yyyy hh:mm:ss";

    SanJavierCalendar(long tiempo) {
        this.setTiempo(tiempo);
        this.tiempo = tiempo;
    }

    public static SanJavierCalendar getInstance() {
        return new SanJavierCalendar();

    }

    public static SanJavierCalendar getInstance(long tiempo) {
        SanJavierCalendar calendar = new SanJavierCalendar(tiempo);
        calendar.setTime(new Date(tiempo));

        return calendar;
    }

    private SanJavierCalendar() {
     ...
     * @return
     */
    public int setCompareTo(SanJavierCalendar date1, SanJavierCalendar date2) throws Exception {    

        if (date2.equals(SanJavierCalendar.getInstance(0))) {
