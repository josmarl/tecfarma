package com.sjcontable.util.io.usb;
 ...
 */
public class SanJavierUsb {
    public static SanJavierUsb instance;
    private List<String> lstNoDisk;

    private SanJavierUsb() {
    ...
    public static SanJavierUsb getInstance() {
        if (instance == null) {
            instance = new SanJavierUsb();
        }
